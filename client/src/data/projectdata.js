import BelayOn from '../images/Belay0n.png'
...
const projectData = [
  ...
  },
  {
    ...
    description:"OneWorld allows the user to retrieve pertinent information of any country in the world! Start by Continent and continue down via sub-continent",
    image:OneWorld,
  ...
  },
  {
    ...
    description:"Full-Stack application that allows the user to create an account and then create a new climb that they've recently sent. Other users are able to leave reviews for any previous climb and give it ratings. Climb On!",
    image:BelayOn,
